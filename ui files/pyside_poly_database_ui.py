...
class Ui_Frame(object):
    ...
    def retranslateUi(self, Frame):
        ...
        self.load_poly_button.setText(QCoreApplication.translate("Frame", u"Load Polygon", None))
        self.save_poly_button.setText(QCoreApplication.translate("Frame", u"Save Polygon", None))
